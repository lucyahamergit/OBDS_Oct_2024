...
#samtools flagstat
samtools flagstat /project/shil5877/1_linux/rnaseq/mapped_reads/ERR1755082.sorted.bam > /project/shil5877/1_linux/rnaseq/mapped_reads/ERR1755082.flagstat

#samtools idxstats
samtools idxstats /project/shil5877/1_linux/rnaseq/mapped_reads/ERR1755082.sorted.bam > /project/shil5877/1_linux/rnaseq/mapped_reads/ERR1755082.idxstats
