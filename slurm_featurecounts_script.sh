...
#featureCounts
#-s = strand-specific read counting, 2=reverse stranded
featureCounts \
 -a /project/shil5877/1_linux/rnaseq/genome/Mus_musculus.GRCm38.102.gtf \
 -t exon \
 -g gene_id \
 -o /project/shil5877/1_linux/rnaseq/quantification/counts.tsv \
 -s 2 \
 -p \
 --countReadPairs \
 -B \
 -C \
 -T 12 \
 /project/shil5877/1_linux/rnaseq/mapped_reads/ERR1755082.sorted.bam
